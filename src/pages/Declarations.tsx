...
export default function Declarations() {
  ...
  useEffect(() => {
    ...
    const target = section === "store" ? storeSectionRef.current : section === "role" ? roleSectionRef.current : null;
    if (!target) return;
  ...
  return (
    ...
    >
      <div className="h-full overflow-y-auto no-scrollbar p-4 space-y-4">
        <Card className="border-0 shadow-sm" ref={roleSectionRef}>
        ...
        <Card className="border-0 shadow-sm" ref={storeSectionRef}>
          <CardContent className="p-4 space-y-4">
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-start gap-3">
                <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 text-primary">
